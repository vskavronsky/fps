...
void AFPSCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind spawn, destroy events
	PlayerInputComponent->BindAction("SpawnActors", IE_Pressed, this, &AFPSCharacter::SpawnActors);
	PlayerInputComponent->BindAction("DestroyActors", IE_Pressed, this, &AFPSCharacter::DestroyActors);
...
void AFPSCharacter::SpawnActors()
{
...
void AFPSCharacter::DestroyActors()
{
